 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://webservice.progredes.et37/", wsdlLocation = "http://localhost:8080/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://webservice.progredes.et37/", "CalculadoraImplService");
     ...
     * 
     * @return
     *     returns CalculadoraInterface
     */
    @WebEndpoint(name = "CalculadoraImplPort")
    public CalculadoraInterface getCalculadoraImplPort() {
        return super.getPort(new QName("http://webservice.progredes.et37/", "CalculadoraImplPort"), CalculadoraInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculadoraImplPort")
    public CalculadoraInterface getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.progredes.et37/", "CalculadoraImplPort"), CalculadoraInterface.class, features);
    }
