 ...
 * generated in the et37.progredes.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _RestarResponse_QNAME = new QName("http://webservice.progredes.et37/", "RestarResponse");
    private final static QName _MultiplicarResponse_QNAME = new QName("http://webservice.progredes.et37/", "MultiplicarResponse");
    private final static QName _DividirResponse_QNAME = new QName("http://webservice.progredes.et37/", "DividirResponse");
    private final static QName _Restar_QNAME = new QName("http://webservice.progredes.et37/", "Restar");
    private final static QName _SumarResponse_QNAME = new QName("http://webservice.progredes.et37/", "SumarResponse");
    private final static QName _Sumar_QNAME = new QName("http://webservice.progredes.et37/", "Sumar");
    private final static QName _Dividir_QNAME = new QName("http://webservice.progredes.et37/", "Dividir");
    private final static QName _Multiplicar_QNAME = new QName("http://webservice.progredes.et37/", "Multiplicar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: et37.progredes.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.progredes.et37/", name = "RestarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.progredes.et37/", name = "MultiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.progredes.et37/", name = "DividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.progredes.et37/", name = "Restar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.progredes.et37/", name = "SumarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.progredes.et37/", name = "Sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.progredes.et37/", name = "Dividir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.progredes.et37/", name = "Multiplicar")
